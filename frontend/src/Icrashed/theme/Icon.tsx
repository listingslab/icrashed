...
import InstrumentalIcon from '@mui/icons-material/PianoOutlined'
import BuyIcon from '@mui/icons-material/ShoppingCartOutlined'
...
export default function Icon({ icon, color }: IconShape) {
  ...
  switch (icon) {
    ...
    case 'scuba':
      ...
      break
    case 'instrumental':
      iconFragment = <InstrumentalIcon color={color} />
      break
    case 'js':
